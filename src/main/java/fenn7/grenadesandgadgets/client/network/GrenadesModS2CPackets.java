...
import fenn7.grenadesandgadgets.client.network.packets.SyncGrenadeS2CPacket;
import fenn7.grenadesandgadgets.client.network.packets.SyncNbtS2CPacket;
...
public class GrenadesModS2CPackets {
    ...
    public static final Identifier SYNC_NBT_S2C = new Identifier(GrenadesMod.MOD_ID, "sync_nbt_s2c");
    public static final Identifier SYNC_GRENADE_S2C = new Identifier(GrenadesMod.MOD_ID, "sync_grenade_s2c");
    ...
    public static void registerS2CPackets() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(SYNC_NBT_S2C, SyncNbtS2CPacket::receive);
        ClientPlayNetworking.registerGlobalReceiver(SYNC_GRENADE_S2C, SyncGrenadeS2CPacket::receive);
    }
}
